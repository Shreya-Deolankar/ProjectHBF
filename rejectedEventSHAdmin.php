...
<div class="columnMain">
        ...
        <ul style="list-style-type:none" class="sideNavUL">
          ...
          but.value="+";
            ...
            <ul style="list-style-type:none;display:none" id="mylist" >
              ...
              <li><input type="button" class="plusButton" class="plusButton" value="-"/><a href="registeredEventSHAdmin.php">Registered</a></li>
          ...
          <li><input type="button" class="plusButton" class="plusButton" value="-"/><a href="sendInviteSHAdmin.php">Send Invite</a></li>
          ...
          <li><input type="button" class="plusButton" class="plusButton" value="-"/><a href="reviewActivitySHAdmin.php">Review Activity</a></li>
      ...
      <div class="middleColumn">
       <div class="middlePadding">
        <h2 class="eventHeading">Rejected Events</h2>
        ...
        <input type="submit" value="Accept" class="eventReject" style="margin-left: 210px;">
        </form>
