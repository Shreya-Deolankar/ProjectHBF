			...
			<div class="columnMain">
				...
				<ul style="list-style-type:none" class="sideNavUL">
					...
					but.value="+";
						...
						<ul style="list-style-type:none;display:none" id="mylist" >
							...
							<li><input type="button" class="plusButton" class="plusButton" value="-"/><a href="registeredEventStuAdmin.php">Registered</a></li>
				...
				<div class="rightColumn">
					<div class="eventGenerator">
	    				...
	    				<option value="s1">old home1</option>
	    				<option value="s2">old home2</option>
  					</select>
